...
- `apps.catalog` contiene el modelo base y su migración inicial para categorías, productos, tipos de licencia y ofertas; no existen todavía interfaces públicas de catálogo, detalle, filtros ni API.

...
- `apps.catalog` contiene el modelo base y su migración inicial para categorías, productos, tipos de licencia y ofertas. La lista pública mínima `/catalog/` muestra productos con producto, categoría y oferta activos, verificada por CA-RF01-01; detalle, filtros, paginación, precio mínimo y API continúan pendientes.
